 ...
 */
export async function instantiate(transform, data) {
  return (await instantiateWithInstance(transform, data)).exports;
}
 ...
 * }>}
 */
export function instantiateWithInstance(transform, data) {
  ...
  if (lastLoadPromise == null) {
    lastLoadPromise = (async () => {
      try {
        const instance = (await instantiateModule(transform,data)).instance;
...
async function instantiateModule(transform, data) {
