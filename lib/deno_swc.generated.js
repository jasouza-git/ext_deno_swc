...
function getUint8Memory0() {
  if (cachedUint8Memory0.byteLength === 0) {
    cachedUint8Memory0 = new Uint8Array(ref.wasm.memory.buffer);
  }
...
function getInt32Memory0() {
  if (cachedInt32Memory0.byteLength === 0) {
    cachedInt32Memory0 = new Int32Array(ref.wasm.memory.buffer);
  }
...
export function minifySync(s, opts) {
  try {
    const retptr = ref.wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passStringToWasm0(
      s,
      ref.wasm.__wbindgen_malloc,
      ref.wasm.__wbindgen_realloc,
    );
    const len0 = WASM_VECTOR_LEN;
    ref.wasm.minifySync(retptr, ptr0, len0, addHeapObject(opts));
    ...
    ref.wasm.__wbindgen_add_to_stack_pointer(16);
  }
}
...
export function parseSync(s, opts) {
  try {
    ...
    const len0 = WASM_VECTOR_LEN;
    ref.wasm.parseSync(retptr, ptr0, len0, addHeapObject(opts));
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var r2 = getInt32Memory0()[retptr / 4 + 2];
    if (r2) {
...
export function printSync(s, opts) {
  try {
    const retptr = ref.wasm.__wbindgen_add_to_stack_pointer(-16);
    ref.wasm.printSync(retptr, addHeapObject(s), addHeapObject(opts));
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var r2 = getInt32Memory0()[retptr / 4 + 2];
    if (r2) {
...
export function transformSync(s, opts) {
  try {
    ...
    const len0 = WASM_VECTOR_LEN;
    ref.wasm.transformSync(retptr, ptr0, len0, addHeapObject(opts));
    var r0 = getInt32Memory0()[retptr / 4 + 0];
    var r1 = getInt32Memory0()[retptr / 4 + 1];
    var r2 = getInt32Memory0()[retptr / 4 + 2];
    if (r2) {
  ...
  __wbindgen_placeholder__: {
    ...
    __wbg_error_09919627ac0992f5: function (arg0, arg1) {
      try {
        ...
        ref.wasm.__wbindgen_free(arg0, arg1);
      }
    },
